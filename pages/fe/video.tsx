...
import Example from "@/components/fe/fe-faqs";
...
import Reviews from "@/components/fe/fe-reviews";
    ...
    <div>
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <div className="container mx-auto px-4 py-6 basis-2/3">
            {/* video */}
            <Tabs />
            ...
            <div className="flex  justify-between p-2 ">
              <div>
                <div className=" flex">
                  <h2 className="text-2xl font-bold  dark:text-white pb-2">
                    Title
                  </h2>
                  <button
                    type="button"
                ...
                <p className="text-gray-700 dark:text-white">
                  ...
                  Minima in aperiam, rem saepe at ipsum voluptas nisi autem
                  excepturi! Repellat assumenda nobis error sed necessitatibus
                  dolorum labore suscipit quis sit? Lorem ipsum dolor, sit amet
                  consectetur adipisicing elit. Minima in aperiam, rem saepe at
                  ipsum voluptas nisi autem excepturi! Repellat assumenda nobis
                  error sed necessitatibus dolorum labore suscipit quis sit?
                </p>
              </div>
                  ...
                  <li className="flex justify-between items-start">
                    ...
                    <div className="mr-3">
                      ...
                      <span className="text-sm">
                        Software enginner at Alphabet Inc.
                      </span>
                    </div>
                    <div>
                      <button
