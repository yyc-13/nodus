...
const FilesInput = forwardRef(
  ({ title, register, files, setFiles, fileType }, ref) => {
    ...
    console.log("title,files,fileType", title, files, fileType);
    return (
      <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 sm:col-span-2">
          {files && files.length > 0 ? (
